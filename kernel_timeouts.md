...
## Citations
- [2_qubit_circuit.lean](https://github.com/KaziMuktadirAhmed/quantum-info-experiment/blob/master/2_qubit_circuit.lean) [cite:5]
- Lean 4.9.0 heartbeat docs [web:54]